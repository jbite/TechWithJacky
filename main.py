...
# llm_page = st.Page("My_Learning_Journey\LLM_Engineering.py", title="LLM Engineernring", icon=":material/robot_2:")
videomesh_page = st.Page("Cisco_Collaboration/Video_mesh.py", title="Video Mesh", icon=":material/robot_2:")

pg = st.navigation(
    {   "Info": [home_page],
        "My Learning Journey": [aws_page, python_page,ml_page, videomesh_page]
    }
)
pg.run()